        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="text-lg leading-8 text-slate-600">
              Spantra Solutions is dedicated to delivering cutting-edge software
              solutions that drive growth, streamline operations, and elevate
              digital experiences.
            </p>
          </div>
        </div>
            ...
            <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
              <div className="flex flex-col items-start bg-slate-50 p-8 rounded-3xl border border-slate-100">
                ...
                <dd className="leading-7 text-gray-600 flex-auto">
                  ...
                  high-quality, robust, and scalable solutions that exceed
                  expectations.
                </dd>
              </div>
              ...
              <div className="flex flex-col items-start bg-slate-50 p-8 rounded-3xl border border-slate-100">
                ...
                <dd className="leading-7 text-gray-600 flex-auto">
                  We believe in strong partnerships with our clients, acting as
                  an extension of their team to achieve mutual success.
                </dd>
              </div>
              ...
              <div className="flex flex-col items-start bg-slate-50 p-8 rounded-3xl border border-slate-100">
                ...
                <dd className="leading-7 text-gray-600 flex-auto">
                  We leverage the latest technologies and methodologies to solve
                  complex problems and create forward-thinking solutions.
                </dd>
              </div>
            </dl>
          </div>
      ...
      <div className="bg-slate-900 py-24 sm:py-32 rounded-[3rem] mx-4 md:mx-10 mb-20 text-center">
        <div className="mx-auto max-w-2xl px-6 lg:px-8">
          ...
          <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-slate-300">
            Let&apos;s turn your vision into reality. We&apos;re here to help
            you navigate the digital landscape.
          </p>
          <div className="mt-10 flex items-center justify-center gap-x-6">
            <Link
              href="/#contact"
              className="rounded-full bg-[#d4ff36] px-8 py-3.5 text-sm text-slate-900 shadow-sm hover:bg-[#bceb16] transition-colors flex items-center gap-2 group"
            >
              Contact Us{" "}
              <ArrowRight
                size={16}
