    ...
    <div className="min-h-screen bg-slate-50 py-20 px-6 sm:px-12 lg:px-24 pt-32">
      <div className="max-w-4xl mx-auto bg-white p-8 sm:p-12 shadow-sm rounded-3xl border border-slate-100">
        ...
        <div className="prose prose-slate max-w-none text-slate-600 space-y-6">
          ...
          <p>
            Welcome to Spantra Solutions (&quot;Company&quot;, &quot;we&quot;,
          ...
          <p>
            When you visit our website, and more generally, use any of our
            services, we appreciate that you are trusting us with your personal
          ...
          <h2 className="text-2xl text-slate-900 mt-8 mb-4">6. Contact Us</h2>
          <p>
