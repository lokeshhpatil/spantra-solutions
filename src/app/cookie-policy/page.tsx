        ...
        <div className="prose prose-slate max-w-none text-slate-600 space-y-6">
          ...
          <ul className="list-disc pl-6 space-y-2 mt-4">
            ...
            <li>
              ...
              contents on the website on social media platforms.
            </li>
            <li>
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">
            4. How can you control the cookie preferences?
          </h2>
          <p>
            Should you decide to change your preferences later through your
            browsing session, you can find the cookie settings in your browser.
            ...
            browser to block/delete the cookies. To find out more out more on
            how to manage and delete cookies, visit wikipedia.org,
            www.allaboutcookies.org.
          </p>

          <h2 className="text-2xl text-slate-900 mt-8 mb-4">5. Contact Us</h2>
          <p>
            If you have questions or comments about this notice, you may email
            us at support@spantra.net
          </p>
        </div>
      </div>
    </div>
