  ...
  return (
    <div className="min-h-screen bg-slate-50 py-20 px-6 sm:px-12 lg:px-24 pt-32">
      <div className="max-w-4xl mx-auto bg-white p-8 sm:p-12 shadow-sm rounded-3xl border border-slate-100">
        <h1 className="text-4xl font-extrabold text-slate-900 mb-8 tracking-tight">Terms of Use</h1>
        ...
        <div className="prose prose-slate max-w-none text-slate-600 space-y-6">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">3. User Representations</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">4. Prohibited Activities</h2>
          <p>
            You may not access or use the Site for any purpose other than that for which we make the Site available. The Site may not be used in connection with any commercial endeavors except those that are specifically endorsed or approved by us.
          </p>

          <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">5. Modifications and Interruptions</h2>
          <p>
          ...
          <p>
            In order to resolve a complaint regarding the Site or to receive further information regarding use of the Site, please contact us at: hello@spantrasolutions.com.
          </p>
        </div>
      </div>
    </div>
